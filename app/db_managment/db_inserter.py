...
class DbInserter(metaclass=Singleton):
    ...
    def create_underlying_one_min_row(
        ...
        self.underlying_one_min_data.append(
            (date_time, time, open, high, low, close, daily_high, daily_low, total_call_volume, total_put_volume,
             option_implied_volatility, call_open_interest, put_open_interest, futures_open_interest)
        )
